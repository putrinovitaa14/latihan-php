...
<body>
    <fieldset>
        <div class="container">
            <table class="tabel_1" border="0">
                ...
                <form action="" method="post">
                    <table align=center cellpadding="6" border=4>
                        <tr>
                            <th></th>
        ...
        <tr>
            <td>7.</td>
            <td>Wisata Pendopo Lawas -> Cafe</td>
            <td></td>
        </tr>
        <tr>
            <td>8.</td>
          ...
          <td></td>
            ...
            <tr> 
                ...
                <td><select name="destinasi" id="">
                    ...
                    <option value="7">Wisata Pendopo Lawas -> Cafe</option>
    ...
    echo '<center>';
         ...
         <?php } elseif ($destinasi == '7') { ?>
            <form action="" method="post"> 
                  <h2 align="center">Wisata Pendopo Lawas -> Cafe</h2>
                ...
                <center>
                    <form action="" method="post">
                        ...
                        <option value="6">Lemon Tea</option>
                            ...
                            <tr>
                                <th colspan="2">
                                    <h3>Note : Tiket ini tidak boleh Hilang! </h3>
                                </th>
                            </tr>
                </center>
                </div>
            ...
            if (isset($_POST['cafe'])) {
                ...
                $kembalian = $bayar - $totalakhir; ?>
                                    <table align="center">
                                        <tr>
                                            <td>
                                                <h3>Kawasan Pendopo Lawas Cafe</h3</td>
                                        </tr>
